...
public class ViewCustomerForm extends javax.swing.JFrame {
    ...
    public ViewCustomerForm() {
        initComponents();
        JTableHeader jth=customerTable.getTableHeader();
    ...
    private void initComponents() {
        ...
        titleLable.setText("View Customer Form");
        ...
        customerTable.setFont(new java.awt.Font("Tahoma", 0, 34)); // NOI18N
    ...
    private void refreshButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_refreshButtonActionPerformed
        try{
            ResultSet resultSet = CustomerController.viewCustomer();
    ...
    /**
     */
    public static void viewCustomerForm() {
